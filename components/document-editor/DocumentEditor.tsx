...
export const DocumentEditor = forwardRef<DocumentEditorHandle, DocumentEditorProps>(function DocumentEditor(
  { initialHtml, initialPageSettings = DEFAULT_PAGE_SETTINGS, editable = true, className, onChange, onSaveRequest },
  ref
) {
          ...
          <div className="doc-page" data-document-page>
            ...
            <div
              className={[
                ...
                !pageSettings.footerHtml?.trim() && pageSettings.showPageNumbers ? "doc-footer-pagenum-only" : "",
              ]
                .filter(Boolean)
                .join(" ")}
            >
