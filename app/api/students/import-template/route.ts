...
export async function GET() {
  ...
  const lines = [
    ...
    "2. Kunci: email domain sekolah. Baris baru = create; email sudah ada = update (kelas/nama/NISN/foto).",
    "3. Nama & kelas opsional saat create (nama kosong → dari bagian email sebelum @). Kelas bisa dilengkapi saat upload ulang.",
    "4. Login siswa memakai email. NISN hanya data tambahan bila diisi.",
    "5. nama_kelas harus sama persis dengan nama kelas di Data Siswa → tab Kelas, contoh: X MIPA 1.",
    "6. Jika email kosong tapi NISN diisi, sistem membuat email otomatis: nisn@domain-siswa sekolah.",
    "7. Jika password kosong saat create, dipakai password default sekolah. Password diisi saat update → reset + wajib ganti.",
    "",
